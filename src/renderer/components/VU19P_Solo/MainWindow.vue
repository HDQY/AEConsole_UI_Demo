<template>
  <div id="main-grid">
    <div id="title-grid" class="drag">
      <div style="margin-left:20px; margin-top:10px; width:375px;">AEConsole( VU19P-Solo ) - ( Emulation Platform Disconnected )</div>
    ...
    <div id="separator-line-cross" />
      ...
      <div id="menu-items" class="stackPanel" style="opacity:1;">
        ...
        <div class="radio menuItem_Radio">
          <input type="radio" id="RemotePowerControl" name="groupName_01" v-on:click="clickButton"/>
        ...
        <div class="radio menuItem_Radio">
          <input type="radio" id="ResetFunction" name="groupName_01" v-on:click="clickButton"/>
        ...
        <div class="radio menuItem_Radio">
          <input type="radio" id="FmcVoltageConfig" name="groupName_01" v-on:click="clickButton"/>
        ...
        <div class="radio menuItem_Radio">
          <input type="radio" id="PllClockConfig_Global" name="groupName_01" v-on:click="clickButton"/>
          <label for="PllClockConfig_Global" style="text-align:right; line-height:42px;">Global Clock     </label>
        </div>
        <div class="radio menuItem_Radio">
          <input type="radio" id="PllClockConfig_MgtRef" name="groupName_01" v-on:click="clickButton"/>
        ...
        <div class="radio menuItem_Radio">
          <input type="radio" id="FpgaConfig" name="groupName_01" v-on:click="clickButton"/>
        ...
        <div class="radio menuItem_Radio">
          <input type="radio" id="BoardSelfTest" name="groupName_01" v-on:click="clickButton"/>
          <label for="BoardSelfTest" style="text-align:right; line-height:42px;">Board Self-Test     </label>
        </div>
        <div class="radio menuItem_Radio">
          <input type="radio" id="RegisterAccess" name="groupName_01" v-on:click="clickButton"/>
      ...
      <div id="separator-line" />
        ...
        <pll-clock-config v-show="selectedId === 'PllClockConfig_Global'"/>
        <pll-clock-config v-show="selectedId === 'PllClockConfig_MgtRef'"/>
...
<script>
  ...
  export default {
    name: 'main-Window',
    components: { TitleBar, FmcVoltageConfig, PllClockConfig, RegAccess, FpgaConfig, },
    data() {
      return {
