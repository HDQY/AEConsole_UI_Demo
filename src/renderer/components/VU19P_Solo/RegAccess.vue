        ...
        <div id="div-FpgaIdSelect">
          <div class="wrapPanel" style="margin: 5px 10px 0px 0px; ">
            <div class="radio fpga-select-radio" >
              <input type="radio" id="fpga_Base" name="groupName_01" checked="true" v-on:click="clickButton_FpgaSelect"/>
              <label for="fpga_Base" >BASE</label>
            </div>
            <div class="radio fpga-select-radio" >
              <input type="radio" id="fpga_1" name="groupName_01" v-on:click="clickButton_FpgaSelect"/>
              <label for="fpga_1" >FPGA1</label>
            </div>
          </div>
        </div>
        <div class="stackPanel" id = "input_addr">
...
<script>
  ...
  export default {
    ...
    methods: {
      clickButton_FpgaSelect:function() {
