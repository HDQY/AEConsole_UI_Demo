...
goog.exportSymbol('proto.AEConsoleGateway.PllConfigStatusInfo', null, global);
/**
 ...
 * @constructor
 */
proto.AEConsoleGateway.PllConfigStatusInfo = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.AEConsoleGateway.PllConfigStatusInfo, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.AEConsoleGateway.PllConfigStatusInfo.displayName = 'proto.AEConsoleGateway.PllConfigStatusInfo';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {string}
 */
proto.AEConsoleGateway.ConnectionStatusInfo.prototype.getErrormessage = function() {
 ...
 * @return {!proto.AEConsoleGateway.ConnectionStatusInfo} returns this
 */
proto.AEConsoleGateway.ConnectionStatusInfo.prototype.setErrormessage = function(value) {
 ...
 * @return {string}
 */
proto.AEConsoleGateway.ConnectionStatusListInfo.prototype.getErrormessage = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 101, ""));
};
 ...
 * @return {!proto.AEConsoleGateway.ConnectionStatusListInfo} returns this
 */
proto.AEConsoleGateway.ConnectionStatusListInfo.prototype.setErrormessage = function(value) {
  return jspb.Message.setProto3StringField(this, 101, value);
};
 ...
 * @return {string}
 */
proto.AEConsoleGateway.DeviceTypeInfo.prototype.getErrormessage = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 101, ""));
};
 ...
 * @return {!proto.AEConsoleGateway.DeviceTypeInfo} returns this
 */
proto.AEConsoleGateway.DeviceTypeInfo.prototype.setErrormessage = function(value) {
  return jspb.Message.setProto3StringField(this, 101, value);
};
 ...
 * @return {!Object}
 */
proto.AEConsoleGateway.PllConfigStatusInfo.prototype.toObject = function(opt_includeInstance) {
  return proto.AEConsoleGateway.PllConfigStatusInfo.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.AEConsoleGateway.PllConfigStatusInfo} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.AEConsoleGateway.PllConfigStatusInfo.toObject = function(includeInstance, msg) {
  var f, obj = {
    deviceid: jspb.Message.getFieldWithDefault(msg, 1, ""),
    boardid: jspb.Message.getFieldWithDefault(msg, 2, ""),
    configstatus: jspb.Message.getFieldWithDefault(msg, 3, 0),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.AEConsoleGateway.PllConfigStatusInfo}
 */
proto.AEConsoleGateway.PllConfigStatusInfo.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.AEConsoleGateway.PllConfigStatusInfo;
  return proto.AEConsoleGateway.PllConfigStatusInfo.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.AEConsoleGateway.PllConfigStatusInfo} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.AEConsoleGateway.PllConfigStatusInfo}
 */
proto.AEConsoleGateway.PllConfigStatusInfo.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.AEConsoleGateway.PllConfigStatusInfo.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.AEConsoleGateway.PllConfigStatusInfo.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.AEConsoleGateway.PllConfigStatusInfo} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.AEConsoleGateway.PllConfigStatusInfo.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getDeviceid();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.AEConsoleGateway.PllConfigStatusInfo.prototype.getDeviceid = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.AEConsoleGateway.PllConfigStatusInfo} returns this
 */
proto.AEConsoleGateway.PllConfigStatusInfo.prototype.setDeviceid = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.AEConsoleGateway.PllConfigStatusInfo.prototype.getBoardid = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.AEConsoleGateway.PllConfigStatusInfo} returns this
 */
proto.AEConsoleGateway.PllConfigStatusInfo.prototype.setBoardid = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};


/**
 * optional AEConsoleBoard.ConfigStatus ConfigStatus = 3;
 * @return {!proto.AEConsoleBoard.ConfigStatus}
 */
proto.AEConsoleGateway.PllConfigStatusInfo.prototype.getConfigstatus = function() {
  return /** @type {!proto.AEConsoleBoard.ConfigStatus} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};
 ...
 * @return {!proto.AEConsoleGateway.PllConfigStatusInfo} returns this
 */
proto.AEConsoleGateway.PllConfigStatusInfo.prototype.setConfigstatus = function(value) {
 ...
 * @return {number}
 */
proto.AEConsoleGateway.PllConfigStatusInfo.prototype.getProgress = function() {
 ...
 * @return {!proto.AEConsoleGateway.PllConfigStatusInfo} returns this
 */
proto.AEConsoleGateway.PllConfigStatusInfo.prototype.setProgress = function(value) {
 ...
 * @return {!proto.AEConsoleBoard.ResultCode}
 */
proto.AEConsoleGateway.PllConfigStatusInfo.prototype.getResultcode = function() {
  return /** @type {!proto.AEConsoleBoard.ResultCode} */ (jspb.Message.getFieldWithDefault(this, 100, 0));
};
 ...
 * @return {!proto.AEConsoleGateway.PllConfigStatusInfo} returns this
 */
proto.AEConsoleGateway.PllConfigStatusInfo.prototype.setResultcode = function(value) {
  return jspb.Message.setProto3EnumField(this, 100, value);
};
 ...
 * @return {string}
 */
proto.AEConsoleGateway.PllConfigStatusInfo.prototype.getErrormessage = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 101, ""));
};
 ...
 * @return {!proto.AEConsoleGateway.PllConfigStatusInfo} returns this
 */
proto.AEConsoleGateway.PllConfigStatusInfo.prototype.setErrormessage = function(value) {
  return jspb.Message.setProto3StringField(this, 101, value);
};
 ...
 * @return {string}
 */
proto.AEConsoleGateway.BoardFpgaConfigInfo.prototype.getErrormessage = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 101, ""));
};
 ...
 * @return {!proto.AEConsoleGateway.BoardFpgaConfigInfo} returns this
 */
proto.AEConsoleGateway.BoardFpgaConfigInfo.prototype.setErrormessage = function(value) {
  return jspb.Message.setProto3StringField(this, 101, value);
};
